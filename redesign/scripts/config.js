...
const ASSET_VERSION = 'assets-v20260610';
const asset = (path) => assetBase + path + '?v=' + ASSET_VERSION;
...
window.WEDDING = {
  ...
  parents: {
    groom: {
      label: '신랑측',
      father: { role: '아버지', name: '조국제', tel: '0123-4567-8910' },
      mother: { role: '어머니', name: '김명선', tel: '0123-4567-8910' }
    },
    bride: {
      label: '신부측',
      father: { role: '아버지', name: '권순문', tel: '0123-4567-8910' },
      mother: { role: '어머니', name: '이은숙', tel: '0123-4567-8910' }
    }
  },

  accounts: {
    groom: [
      { holder: '조영민',        bank: '농협',     number: '0123-4567-8910' },
      { holder: '조국제 (아버지)', bank: '농협',     number: '0123-4567-8910' },
      { holder: '김명선 (어머니)', bank: '농협',     number: '0123-4567-8910' }
    ],
    bride: [
      { holder: '권채린',        bank: '기업은행',  number: '0123-4567-8910' },
      { holder: '권순문 (아버지)', bank: '신한은행',  number: '0123-4567-8910' },
      { holder: '이은숙 (어머니)', bank: '하나은행',  number: '0123-4567-8910' }
    ]
  },
